...
R67:
	P_u1 > P_c1 + Acquisition
	rho_D * psi * P_u1 * (D_c1 / (D_c1 + D_u1))

R68:
	P_u1 > P_c1 + Acquisition
	rho_D * psi * P_u1 * (D_c2 / (D_c2 + D_u2))
...
R76:
	P_u2 > P_c2 + Acquisition
	rho_D * psi * P_u2 * (D_c1 / (D_c1 + D_u1))	

R77:
	P_u2 > P_c2 + Acquisition
	rho_D * psi * P_u2 * (D_c2 / (D_c2 + D_u2))
...
R85:
	P_u3 > P_c3 + Acquisition
	rho_D * psi * P_u3 * (D_c1 / (D_c1 + D_u1))
	
R86:
	P_u3 > P_c3 + Acquisition
	rho_D * psi * P_u3 * (D_c2 / (D_c2 + D_u2))	
...
R94:
	P_u4 > P_c4 + Acquisition
	rho_D * psi * P_u4 * (D_c1 / (D_c1 + D_u1))

R95:
	P_u3 > P_c3 + Acquisition
	rho_D * psi * P_u4 * (D_c2 / (D_c2 + D_u2))	
...
R103:
	P_u5 > P_c5 + Acquisition
	rho_D * psi * P_u5 * (D_c1 / (D_c1 + D_u1))

R104:
	P_u3 > P_c3 + Acquisition
	rho_D * psi * P_u5 * (D_c2 / (D_c2 + D_u2))	
